    ...
    public partial class FrmLogin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            {  
                ...
                //string connString = "server=.;database=StudentDB;uid=sa;pwd=123456;";//Sql server身份验证
                ...
                //object o=cmd.ExecuteScalar();  //执行查询，返回结果集第一行第一列的值，忽略其他行其他列
                ////关闭连接
                //conn.Close(); 
                #endregion
